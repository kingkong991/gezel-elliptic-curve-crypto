...
Het is opmerkelijk dat het dynamisch verbruik van CG~2 zo veel lager wordt gerapporteerd dan dat van de andere twee CG implementaties. Dit is mogelijk te verklaren door het feit dat de synthese software in de CG~2 implementatie de clock gating schakeling herkent. Waarschijnlijk wordt daar dus bij de berekening van het verbruik ook rekening mee gehouden. In werkelijkheid zal implementatie CG~3 het minste verbruiken.
