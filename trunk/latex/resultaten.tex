...
\begin{table}[h]
	...
	\footnotemark[3] Des te lager, des te conservatiever springt de implementatie om met energie. %De effici\"entie wordt berekend als: $\frac{\text{vermogen} \cdot \text{rekentijd}}{\text{veiligheid}}$.
\end{table}
