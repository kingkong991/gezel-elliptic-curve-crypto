...
Normaal wordt de energie-effici\"entie berekend als vermogen gedeeld door de throughput. Daarbij wordt echter geen rekening gehouden met de veiligheid van de schakeling. Het is dan mogelijk een schakeling te cre\"eren met enkel een kloksignaal dat sowieso de beste energie-effici\"entie zal hebben. De veiligheid zal echter gelijk zijn aan 0 bit en het is uiteraard niet het geval dat zo een schakeling er bij een vergelijking als beste uitkomt. Vandaar het voorstel voor een lichtelijk aangepaste formule.
